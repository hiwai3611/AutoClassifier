...
### 最終課題
#file_model = 'final_hr_analysis_train.csv'
#file_score = 'final_hr_analysis_test.csv'
#ohe_cols = ['sales',
#			'salary'
#			]
...
plt.xticks(range(X_ohe.shape[1]), feat_labels[indices], rotation=90, fontsize=20)
...
models = [lr, knn, svm, dc, rf, rsvc, bag, gb1, xgb1, xgb2]
...
IDs.join(score).to_csv('./data/'+  BEST_ALGORITHM + '_' + file_score + '_with_pred.csv', index=False)
